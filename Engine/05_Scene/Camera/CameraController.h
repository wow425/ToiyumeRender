...
public:
    ...
    CameraController(Renderer::Camera& camera) : m_TargetCamera(camera) {}
...
protected:
    Renderer::Camera& m_TargetCamera;
...
public:
    ...
    FlyingFPSCamera(Renderer::Camera& camera, Math::Vector3 worldUp);
...
private:
    ...
    // -----------------------------------------------------------
    Math::Vector3 m_WorldUp;    // 世界的正上方 (0, 1, 0)
    Math::Vector3 m_WorldNorth; // 世界的正北方 (通常是 +Z，即 0, 0, 1)
    Math::Vector3 m_WorldEast;  // 世界的正东方 (通常是 +X，即 1, 0, 0)
