...
int D3DApp::Run()
{
	...
	while(msg.message != WM_QUIT)
	{
		...
		if(PeekMessage( &msg, 0, 0, 0, PM_REMOVE )) // 获取消息
		{
            ...
            DispatchMessage( &msg ); // 传给WndProc函数处理
		}
...
// 开调试层，创factory，枚举创adapter，创commandobject，swapchain，DescriptorHeaps
...
// 设定CPU围栏值,GPU围栏值，比较两者大小以判断GPU是否完成命令
